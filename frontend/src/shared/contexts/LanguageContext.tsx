...
const translations = {
  ...
  'nav.faq': 'FAQ',
  'nav.try_out': 'Try Out',
  'language.current': '🇷🇺 Russian Version',
  'language.switch': '🇬🇧 English Version',
    
    // Hero
    'hero.title': 'Never take meeting notes by hand again',
  'hero.subtitle': 'AI note-taker for calls',
  'hero.platforms': 'on',
  'hero.description': 'Get a ready-to-send summary in seconds with AI transcription and smart formatting.',
  'hero.tagline': 'No manual notes. No misses.',
  'hero.try': 'Try in',
  ...
  'features.ai.description': 'Advanced machine learning extracts key insights and tasks automatically.',
  'features.formatting.title': 'Smart Formatting',
  'features.formatting.description': 'Professional summaries with proper structure, bullets, and highlighted decisions.',
  'features.sharing.title': 'Instant Sharing',
  'features.sharing.description': 'One-click distribution to your team, stakeholders, or favorite productivity tools.',
  'features.search.title': 'Searchable Archive',
  'features.search.description': 'Find any discussion, decision, or detail from past meetings with powerful search.',
  ...
  'landing.integrations.subtitle': 'Seamless integration with the platforms your team uses daily for maximum productivity.',
  'landing.integrations.coming_soon': 'And many more integrations coming soon',
  'landing.integrations.badge': 'Integrations',
  'landing.integrations.connect_instantly': 'Connect Instantly',
  'landing.integrations.workflow': 'Optimize Your Workflow',

  // Pricing
  'pricing.title': '💼 Pricing',
  'pricing.subtitle': 'Choose the plan that fits your team. Change your plan at any time.',
  'pricing.monthly': 'Monthly',
  'pricing.annual': 'Annual',
  'pricing.discount': 'Save 17%',
  'pricing.note': 'All plans include a 14-day free trial. No credit card required.',
  'pricing.mobile_tip': '💡 The 3D tilt effect works best on desktop',
  ...
  'feature.lite.2': 'Automatic transcription',
  'feature.lite.3': 'Export notes to PDF',
  'feature.lite.4': 'Google Meet integration',

  'feature.pro.1': 'Up to 30 hours of recording per month',
  'feature.pro.2': 'Transcription and summaries',
  'feature.pro.3': 'Integrations: Slack, Zoom, Google Meet',
  'feature.pro.4': 'Export to Word and PDF',
  'feature.pro.5': 'Priority processing',

  'feature.enterprise.1': 'Unlimited recording hours',
  'feature.enterprise.2': 'Team collaboration',
  'feature.enterprise.3': 'All integrations: Slack, Zoom, Meet, Notion, and more',
  'feature.enterprise.4': 'Personalized reports',
  'feature.enterprise.5': 'Dedicated manager and 99.9% SLA',
    
    // Plan specific
    'plan.popular': 'NOT INTEGRATED YET',
    'plan.from': 'from',
  'plan.currency': '$',
  ...
  'plan.lets_talk': 'Let’s talk',
    ...
    // Mobile CTA
    'mobile_cta.title': 'Ready to start?',
